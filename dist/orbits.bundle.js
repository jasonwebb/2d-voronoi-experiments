...
/* harmony import */ var _Ring__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Ring */ "./orbits/js/Ring.js");
  ...
  function generatePoints() {
    ...
    for (let i = 0; i < numRings; i++) {
      ...
      if(i != 1) {
        ...
        ring = new _Ring__WEBPACK_IMPORTED_MODULE_1__["default"](numPoints, currentRadius);
      ...
      // Add sub-rings to the outermost main ring
        ...
        for(let point of ring.points) {
          let subring = new _Ring__WEBPACK_IMPORTED_MODULE_1__["default"](subringPoints, subringRadius, point[0], point[1]);
          subring.velocity = .01;
